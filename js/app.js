...
let message = `There once was a moronic Kaiju Street Sweeper named ${name}, who had flunked out of the Defense Force tryouts ${age} TIMES! And yet, ${name} would not give up! So with the help of ${name}'s faithful ${animal.toLowerCase()} companion, Rathsheeba, one ${season.toLowerCase()} morning, ${name} FINALLY was inducted into the Defense Force to fight the unabading Kaiju and their relentless assault!`
